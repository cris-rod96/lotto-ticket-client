...
//   useEffect(() => {
//     setCurrentPage(1)
//   }, [filterPuntoVenta, filterFecha, filterEstado, filterCodigo, filterFechaInicio, filterFechaFin])
...
//         className="bg-[#111615] border border-white/5 p-5 rounded-3xl mb-8 flex flex-col gap-6"
//       >
//         {/* FILA 1: BÚSQUEDA Y FECHAS */}
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
//           {/* 1. Búsqueda por Código - Ocupa 2 espacios en pantallas grandes */}
...
//               <LuSearch size={10} /> Buscar por Código
//             </label>
//             <input
//               type="text"
...
//               className="w-full bg-black/40 border border-white/5 text-white rounded-2xl py-3.5 px-4 text-xs font-medium focus:outline-none focus:border-luck-gold/30 transition-all placeholder:text-zinc-700"
//             />
//           </div>
...
//             <label className="text-[9px] font-black uppercase text-zinc-500 tracking-wider flex items-center gap-1">
//               <LuCalendar size={10} /> Desde
//             </label>
//             <input
//               type="date"
//               value={filterFechaInicio}
//               onChange={(e) => setFilterFechaInicio(e.target.value)}
//               className="w-full bg-black/40 border border-white/5 text-white rounded-2xl py-3.5 px-4 text-xs focus:outline-none focus:border-luck-gold/30 transition-all uppercase cursor-pointer"
//             />
//           </div>

//           <div className="flex flex-col gap-2">
//             <label className="text-[9px] font-black uppercase text-zinc-500 tracking-wider flex items-center gap-1">
//               <LuCalendar size={10} /> Hasta
//             </label>
//             <input
//               type="date"
...
//         {/* FILA 2: SELECTS Y CONTADOR */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 items-end">
//           {/* 3. Filtros existentes (Punto Venta y Estado) */}
//           <div className="flex flex-col gap-2">
...
//               className="w-full bg-black/40 border border-white/5 text-white rounded-2xl py-3.5 px-4 text-xs cursor-pointer"
//             >
...
//           <div className="flex flex-col gap-2 lg:col-start-6 lg:justify-self-end">
